...
import {getDenounceList,lockPost,deletePost,getPostByAdmin} from '../../store/slice/postSlice'
...
const AdminPostList = () => {
    ...
    const {postList,isSuccess,successMessage,adminPostList} = useSelector(state => state.post); 
    ...
    useEffect(()=>{
      dispatch(getPostByAdmin(user.data._id)); 
    },[]) 
  return (
                ...
                <>
                  ...
                  <Card>
                    <CardBody>
                      ...
                      <button onClick={()=> setShowCreatePost(true)} className="btn btn-success"><i class="bi bi-pencil-square"></i> Tạo bài viết</button>
                      </div>
                      ...
                      <Table className="no-wrap mt-3 align-middle" responsive borderless>
                        ...
                        <tbody>
                          {adminPostList?.length > 0 && adminPostList?.map((tdata, index) => (
                 ...
                 <Row style={{width:850, height:650}}>                
                    <CardTitle tag="h5"> <i style={{cursor:'pointer'}} onClick={()=>setViewSinglePost(false)} class="bi bi-arrow-left"></i> Chi tiết bài viết </CardTitle>
                      <div style={{height:850,height:650,margin:'0 auto'}}>   
